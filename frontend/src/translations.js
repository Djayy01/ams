...
export const STR = {
  en: {
    ...
    phoneInvalid:"Please enter a valid 10-digit US phone number.",
    useMyLocation:"Use my current location", locating:"Locating…",
    geoDenied:"Location access was denied, you can type your address instead.",
    geoUnavailable:"Couldn't get your location, please type your address or intersection.",
  },
  es: {
    ...
    phoneInvalid:"Por favor ingresa un número de teléfono válido de 10 dígitos.",
    useMyLocation:"Usar mi ubicación actual", locating:"Ubicando…",
    geoDenied:"Se denegó el acceso a la ubicación, puedes escribir tu dirección.",
    geoUnavailable:"No se pudo obtener tu ubicación, escribe tu dirección o cruce de calles.",
  },
};